  ...
  return (
    <div className="max-w-4xl card-elevated">
      ...
      <section className="mt-2 space-y-4">
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />International Recognition &amp; Credibility</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />Highfield and the Security Industry</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />Why Highfield Qualifications Matter</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />Quality Assurance &amp; Compliance</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />Naroz Shield Institute &amp; Highfield Alignment</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold mt-4 section-header"><span className="marker" aria-hidden />A Commitment to Professional Standards</h3>
