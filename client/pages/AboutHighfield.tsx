  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-16">
        ...
        <SectionHeader
          title="About Highfield Qualifications"
          subtitle="An International Awarding Body for Professional Excellence"
        />
        <p className="lead mt-6 text-center mx-auto max-w-3xl">
          Highfield Qualifications is a UK-based awarding organisation
          recognised internationally for the development and certification of
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-4">
                An awarding organisation is responsible for designing
                qualification frameworks, defining learning outcomes and
                assessment criteria, ensuring qualifications meet regulated
                standards, monitoring training centres through quality assurance
                and audits, and issuing recognised certificates and diplomas.
              </p>
              <p className="text-muted-foreground">
                Highfield does not deliver training directly. Instead, it
                ensures that training delivered by approved centres meets
                defined, audited and regulated requirements.
              </p>
            </div>
          </div>
        </Card>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <Card className="p-6 bg-gray-50">
          ...
          <p className="text-muted-foreground mb-4">
            Highfield qualifications are widely recognised across multiple
            sectors, including:
          </p>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Because Highfield qualifications are regulated and externally
            quality-assured, they offer learners professional credibility and
        ...
        <Card className="p-6 bg-white">
          <h3 className="text-xl mb-3 text-primary">
            Highfield and the Security Industry
          </h3>
          <p className="text-muted-foreground">
            Within the private security sector, Highfield awards qualifications
            that are:
          </p>
          <ul className="space-y-2 text-sm mt-4">
            ...
            <li className="flex items-start gap-2">
              <span className="text-primary">✓</span>
              <span>
                Accepted by licensing authorities such as the Security Industry
                Authority (SIA)
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">✓</span>
              <span>
                Recognised by employers operating in international and high-risk
                environments
              </span>
            </li>
          </ul>
      ...
      <div className="mb-12">
        <Card className="p-8 bg-primary text-primary-foreground">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-90">
                  Rigorous approval and ongoing monitoring
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-90">
                  Internal quality assurer (IQA) standards
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
          ...
          <p className="text-sm opacity-90 mt-6">
            This ensures that every learner is assessed against the same
            standards, regardless of where the training is delivered.
          </p>
        </Card>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <Card className="p-6">
          <h3 className="text-xl mb-3 text-primary">
            Naroz Shield Institute &amp; Highfield Alignment
          </h3>
          <p className="text-muted-foreground mb-4">
            Naroz Shield Institute delivers training programmes aligned with
            Highfield qualifications, ensuring that learners benefit from:
          </p>
          <ul className="space-y-2 text-sm">
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
        ...
        <Card className="p-6 bg-gray-50">
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Highfield qualifications are an essential element for individuals
            seeking to operate responsibly and legitimately within regulated
            industries.
          </p>
        </Card>
      </div>
      ...
      <div className="mb-12">
        <Card className="p-8 border-2 border-primary/20">
          ...
          <p className="text-foreground mb-6">
            Highfield Qualifications is an independent awarding organisation.
            Certification is issued following successful assessment in
            accordance with Highfield requirements. Naroz Shield Institute does
            not issue Highfield certificates independently and complies fully
