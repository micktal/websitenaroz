    ...
    <div>
      ...
      <div className="mb-12 -mt-10 -mx-4 lg:-mx-8">
        <div className="relative h-[400px] overflow-hidden group">
          ...
          <div className="absolute inset-0 opacity-10 group-hover:opacity-0 transition-opacity duration-700" style={{
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                ...
                <p className="text-xl text-white/90 mb-6">
                  Master defensive driving, convoy operations and emergency manoeuvres
                </p>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-6 flex gap-3">
          <a href="/contact?course=Tactical%20Driving%20Programme" className="inline-flex items-center px-6 py-3 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-lg">Book this course</a>
        </div>
