          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our grand reception halls and ceremonial spaces provide the perfect setting for diplomatic protection training scenarios. Students learn to navigate high-profile events in an environment that mirrors real-world diplomatic settings.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg mb-1">Authentic Training Environments</h3>
                    <p className="text-muted-foreground">Marble halls, crystal chandeliers, and period furnishings create realistic diplomatic scenarios.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-lg mb-1">Professional Briefing Rooms</h3>
                    <p className="text-muted-foreground">Equipped for strategic planning and tactical briefings.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Year-round training in optimal conditions.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:order-1 order-2">
              <h2 className="text-4xl mb-6">Close Protection Training Grounds</h2>
              <p className="text-lg text-muted-foreground mb-6">
                Our extensive grounds feature outdoor training areas designed for tactical exercises, protective formations, and vehicle security operations. The combination of classical architecture and open spaces provides diverse training scenarios.
              </p>
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h4 className="mb-2">Tactical Training</h4>
                  <p className="text-sm text-muted-foreground">Formations, advances, and protective movements</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h4 className="mb-2">Vehicle Operations</h4>
                  <p className="text-sm text-muted-foreground">Convoy security and defensive driving</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h4 className="mb-2">Perimeter Security</h4>
                  <p className="text-sm text-muted-foreground">Advanced surveillance detection</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h4 className="mb-2">Night Operations</h4>
                  <p className="text-sm text-muted-foreground">Low-light tactical scenarios</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group lg:order-2 order-1">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-lg shadow-xl border border-gray-200 z-10">
                ...
                <div className="text-sm text-muted-foreground">Acres of Training Grounds</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Every element of our facility is designed to provide the most realistic and comprehensive training experience.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">18th-century inspired design with modern amenities</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">24/7 security with controlled access</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">Extensive resources and reference materials</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">On-site lodging for residential courses</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/90 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl mb-6">Experience the Illiria Difference</h2>
            <p className="text-xl mb-8 text-white/90">
              Train in a facility that reflects the caliber of protection professionals we develop.
            </p>
