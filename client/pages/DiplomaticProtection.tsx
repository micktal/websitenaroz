  ...
  return (
    <div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                ...
                <p className="text-xl text-white/90 mb-6">
                  Elite training for high-profile diplomatic and executive
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-6">
          <a
            href="/contact?course=Diplomatic%20Protection%20Programme"
          ...
          <section className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                The Diplomatic Protection Programme is a specialised, intensive
                training course designed to prepare security professionals for
                protective duties involving diplomats, international officials,
                government representatives and high-profile individuals
                operating in sensitive or hostile environments.
              </p>
              <p className="mt-2 text-muted-foreground">
                This programme focuses on protective planning, operational
                coordination, threat mitigation and professional conduct, with a
                controlled and realistic integration of tactical shooting
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Practical exercises, scenario work and continuous instructor
                assessment. Successful candidates receive a certificate of
                completion.
              </p>
            </div>
          </section>
