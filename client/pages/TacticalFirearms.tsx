  ...
  return (
    <div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                ...
                <p className="text-xl text-white/90 mb-6">
                  Professional firearms training in realistic operational
                  environments
                </p>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-6">
          <a
            href="/contact?course=Tactical%20Firearms%20Programme"
        ...
        <Card>
          ...
          <p className="mt-2 text-muted-foreground">
            Professional firearms training emphasising safe handling,
            marksmanship fundamentals, scenario-based shooting and legal
            considerations for protective roles.
          </p>
        </Card>
      </div>
    </div>
